...
public interface MultiSet<E> {
     ...
     * It will contain all elements that are present in at least one of the initial Multi-Sets.
     * The multiplicity of each element is equal to the maximum multiplicity of
     * the corresponding elements in both Multi-Sets.
     */
    void union(MultiSet<E> other);

    /**
     * Intersect this multiset with another one. The result is the modified multiset (this).
     * It will contain all elements that are present in the both Multi-Sets.
     * The multiplicity of each element is equal to the minimum multiplicity of
     * the corresponding elements in the intersecting Multi-Sets.
     */
